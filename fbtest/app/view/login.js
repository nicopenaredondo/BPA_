...
Ext.define('fbtest.view.login', {
    ...
    showLoginText: function() {
        ...
        var redirectUrl = Ext.Object.toQueryString({
            ...
            client_id: fbtest.app.facebookAppId,
            response_type: 'token'
        });
        ...
        this.setHtml([
            ...
            '<div class="fb-facepile" data-app-id="' + fbtest.app.facebookAppId + '" data-max-rows="2" data-width="300"></div>'
        ].join(''));
